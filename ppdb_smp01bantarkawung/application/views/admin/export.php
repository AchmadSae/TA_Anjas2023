...
<head>
  ...
  <link rel="icon" type="image/png" href="assets/images/smaja3.png" />
  <style>
    table {
  ...
  <table width="100%" border="1">
    ...
    foreach ($v_siswa->result() as $baris):
      ...
      <tr>
        ...
        <td>
          <?php echo ucwords($baris->nama_lengkap); ?>
        </td>
        <td>
          <?php echo $baris->jk; ?>
        </td>
        <td>
          <?php echo "$baris->tempat_lahir, " . $this->Model_data->tgl_id($baris->tgl_lahir); ?>
        </td>
        <td>
          <?php echo $baris->agama; ?>
        </td>
        <td>
          <?php echo $baris->status_keluarga; ?>
        </td>
        <td>
          <?php echo $baris->alamat_siswa; ?>
        </td>
        <td>
          <?php echo $baris->no_hp_siswa; ?>
        </td>
        <td>
          <?php echo number_format($ipa->semester1, 2, ",", "."); ?>
        </td>
        <td>
          <?php echo number_format($ipa->semester2, 2, ",", "."); ?>
        </td>
        <td>
          <?php echo number_format($ipa->semester3, 2, ",", "."); ?>
        </td>
        <td>
          <?php echo number_format($ipa->semester4, 2, ",", "."); ?>
        </td>
        <td>
          <?php echo number_format($ipa->semester5, 2, ",", "."); ?>
        </td>
        <th>
          <?php echo number_format($ipa->rata_rata_nilai, 2, ",", "."); ?>
        </th>
        <td>
          <?php echo number_format($ips->semester1, 2, ",", "."); ?>
        </td>
        <td>
          <?php echo number_format($ips->semester2, 2, ",", "."); ?>
        </td>
        <td>
          <?php echo number_format($ips->semester3, 2, ",", "."); ?>
        </td>
        <td>
          <?php echo number_format($ips->semester4, 2, ",", "."); ?>
        </td>
        <td>
          <?php echo number_format($ips->semester5, 2, ",", "."); ?>
        </td>
        <th>
          <?php echo number_format($ips->rata_rata_nilai, 2, ",", "."); ?>
        </th>
        <td>
          <?php echo number_format($mtk->semester1, 2, ",", "."); ?>
        </td>
        <td>
          <?php echo number_format($mtk->semester2, 2, ",", "."); ?>
        </td>
        <td>
          <?php echo number_format($mtk->semester3, 2, ",", "."); ?>
        </td>
        <td>
          <?php echo number_format($mtk->semester4, 2, ",", "."); ?>
        </td>
        <td>
          <?php echo number_format($mtk->semester5, 2, ",", "."); ?>
        </td>
        <th>
          <?php echo number_format($mtk->rata_rata_nilai, 2, ",", "."); ?>
        </th>
        <td>
          <?php echo number_format($ind->semester1, 2, ",", "."); ?>
        </td>
        <td>
          <?php echo number_format($ind->semester2, 2, ",", "."); ?>
        </td>
        <td>
          <?php echo number_format($ind->semester3, 2, ",", "."); ?>
        </td>
        <td>
          <?php echo number_format($ind->semester4, 2, ",", "."); ?>
        </td>
        <td>
          <?php echo number_format($ind->semester5, 2, ",", "."); ?>
        </td>
        <th>
          <?php echo number_format($ind->rata_rata_nilai, 2, ",", "."); ?>
        </th>
        <td>
          <?php echo number_format($ing->semester1, 2, ",", "."); ?>
        </td>
        <td>
          <?php echo number_format($ing->semester2, 2, ",", "."); ?>
        </td>
        <td>
          <?php echo number_format($ing->semester3, 2, ",", "."); ?>
        </td>
        <td>
          <?php echo number_format($ing->semester4, 2, ",", "."); ?>
        </td>
        <td>
          <?php echo number_format($ing->semester5, 2, ",", "."); ?>
        </td>
        <th>
          <?php echo number_format($ing->rata_rata_nilai, 2, ",", "."); ?>
        </th>
        <th>
          <?php echo $rata_rata_rapor; ?>
        </th>
        <td>
          <?php echo number_format($agama->nilai_usbn, 2, ",", "."); ?>
        </td>
        <td>
          <?php echo number_format($pkn->nilai_usbn, 2, ",", "."); ?>
        </td>
        <td>
          <?php echo number_format($ind2->nilai_usbn, 2, ",", "."); ?>
        </td>
        <td>
          <?php echo number_format($ing2->nilai_usbn, 2, ",", "."); ?>
        </td>
        <td>
          <?php echo number_format($mtk2->nilai_usbn, 2, ",", "."); ?>
        </td>
        <td>
          <?php echo number_format($ipa2->nilai_usbn, 2, ",", "."); ?>
        </td>
        <td>
          <?php echo number_format($ips2->nilai_usbn, 2, ",", "."); ?>
        </td>
        <th>
          <?php echo number_format($jumlah_usbn, 2, ",", "."); ?>
        </th>
        <th>
          <?php echo number_format($jumlah_usbn / 7, 2, ",", "."); ?>
        </th>
        <td>
          <?php echo number_format($ipa3->nilai_unbk, 2, ",", "."); ?>
        </td>
        <td>
          <?php echo number_format($mtk3->nilai_unbk, 2, ",", "."); ?>
        </td>
        <td>
          <?php echo number_format($ind3->nilai_unbk, 2, ",", "."); ?>
        </td>
        <td>
          <?php echo number_format($ing3->nilai_unbk, 2, ",", "."); ?>
        </td>
        <th>
          <?php echo number_format($jumlah_unbk, 2, ",", "."); ?>
        </th>
        <th>
          <?php echo number_format($jumlah_unbk / 4, 2, ",", "."); ?>
        </th>
      </tr>
      <?php
    endforeach; ?>
