  ...
  <div class="panel-body">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-9" style="margin-top:3px;">
        <select class="form-control bg-blue class" data-placeholder="Pilih jenis tempat tinggal" name="jenis_tinggal" none-data-parsley-group="block2" data-parsley-errors-container='div[id="error-jenis_tinggal"]' required>
    ...
    <div class="form-group" style="padding-bottom:30px;">
      ...
      <div class="col-sm-9 prepend-icon">
        <input type="text" name="alamat_siswa" class="form-control bg-blue" placeholder="Alamat siswa" maxlength="100" none-data-parsley-group="block2" data-radio="iradio_square-blue" data-parsley-errors-container='div[id="error-alamat_siswa"]' required>
    ...
    <div class="form-group" style="padding-bottom:30px;">
      ...
      <div class="col-sm-9 prepend-icon">
        <input type="text" name="desa" class="form-control bg-blue" placeholder="Desa" maxlength="100" none-data-parsley-group="block2" data-radio="iradio_square-blue" data-parsley-errors-container='div[id="error-desa"]' required>
    ...
    <div class="form-group" style="padding-bottom:30px;">
      ...
      <div class="col-sm-9 prepend-icon">
        <input type="text" name="kec" class="form-control bg-blue" placeholder="Kecamatan" maxlength="100" none-data-parsley-group="block2" data-radio="iradio_square-blue" data-parsley-errors-container='div[id="error-kec"]' required>
        <i class="fa fa-map-marker" style="margin-left:15px;"></i>
    ...
    <div class="form-group" style="padding-bottom:30px;">
      ...
      <div class="col-sm-9 prepend-icon">
        <input type="text" name="kab" class="form-control bg-blue" placeholder="Kabupaten" maxlength="100" none-data-parsley-group="block2" data-radio="iradio_square-blue" data-parsley-errors-container='div[id="error-kab"]' required>
        <i class="fa fa-map-marker" style="margin-left:15px;"></i>
    ...
    <div class="form-group" style="padding-bottom:30px;">
      ...
      <div class="col-sm-9 prepend-icon">
        <input type="text" name="prov" class="form-control bg-blue" placeholder="Provinsi" maxlength="100" none-data-parsley-group="block2" data-radio="iradio_square-blue" data-parsley-errors-container='div[id="error-prov"]' required>
        <i class="fa fa-map-marker" style="margin-left:15px;"></i>
    ...
    <div class="form-group" style="padding-bottom:30px;">
      ...
      <div class="col-sm-9 prepend-icon">
        <input type="text" name="kode_pos" class="form-control bg-blue" placeholder="Kode pos" maxlength="100" none-data-parsley-group="block2" data-radio="iradio_square-blue" data-parsley-errors-container='div[id="error-kode_pos"]' required>
        <i class="fa fa-map-marker" style="margin-left:15px;"></i>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-9" style="margin-top:3px;">
        <select class="form-control bg-blue class" data-placeholder="Jarak ke sekolah" name="jarak" none-data-parsley-group="block2" data-parsley-errors-container='div[id="error-jarak"]' required>
          <option value="">Pilih jarak siswa ke sekolah</option>
          <option value="1">Kurang dari 2 km</option>
          <option value="2">2 - 6 km</option>
          <option value="3">6 - 10 km</option>
          <option value="4">10 - 20 km</option>
          <option value="5">Lebih dari 20 km</option>
        </select>
        <div id="error-jarak" style=" background:#FFBABA;color: #D8000C; width:auto;border-radius:5px;padding-left:10px;"></div>
      </div>
    </div>
    <div class="form-group">
    <label class="col-sm-3 control-label" style="text-align:right; margin-top:6px">Link Lokasi Google Maps <span class="text-danger">*</span></label>
      <div class="col-sm-9 prepend-icon">
        <input type="text" name="gMaps" class="form-control bg-blue" placeholder="link gmaps" maxlength="100" none-data-parsley-group="block2" data-radio="iradio_square-blue" data-parsley-errors-container='div[id="error-gMaps"]' required>
        <i class="fa fa-map-marker" style="margin-left:15px;"></i>
        <div id="error-gMaps" style=" background:#FFBABA;color: #D8000C; width:auto;border-radius:5px;padding-left:10px;"></div>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-9" style="margin-top:3px;">
        <select class="form-control bg-blue class" data-placeholder="Transportasi yang digunakan" name="trans" none-data-parsley-group="block2" data-parsley-errors-container='div[id="error-trans"]' required>
